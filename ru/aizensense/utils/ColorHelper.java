...
public class ColorHelper {
    ...
    public static int toRGBA(float r, float g, float b, float a) {
        return ColorHelper.toRGBA((int)(r * 255.0f), (int)(g * 255.0f), (int)(b * 255.0f), (int)(a * 255.0f));
    }
    ...
    public static int toRGBA(float[] colors) {
        ...
        return ColorHelper.toRGBA(colors[0], colors[1], colors[2], colors[3]);
    }
    ...
    public static int toRGBA(double[] colors) {
        ...
        return ColorHelper.toRGBA((float)colors[0], (float)colors[1], (float)colors[2], (float)colors[3]);
    }
    ...
    public static Color TwoColoreffect(Color cl1, Color cl2, double speed) {
        ...
        float val = MathHelper.clamp((float)((float)Math.sin(Math.PI * 6 * thing) / 2.0f + 0.5f), (float)0.0f, (float)1.0f);
        return new Color(ColorHelper.lerp((float)cl1.getRed() / 255.0f, (float)cl2.getRed() / 255.0f, val), ColorHelper.lerp((float)cl1.getGreen() / 255.0f, (float)cl2.getGreen() / 255.0f, val), ColorHelper.lerp((float)cl1.getBlue() / 255.0f, (float)cl2.getBlue() / 255.0f, val));
    }
    ...
    public static int getTeamColor(Entity entityIn) {
        int i = -1;
        i = entityIn.getDisplayName().getUnformattedText().equalsIgnoreCase("\u043f\u0457\u0405f[\u043f\u0457\u0405cR\u043f\u0457\u0405f]\u043f\u0457\u0405c" + entityIn.getName()) ? ColorHelper.getColor(new Color(255, 60, 60)) : (entityIn.getDisplayName().getUnformattedText().equalsIgnoreCase("\u043f\u0457\u0405f[\u043f\u0457\u04059B\u043f\u0457\u0405f]\u043f\u0457\u04059" + entityIn.getName()) ? ColorHelper.getColor(new Color(60, 60, 255)) : (entityIn.getDisplayName().getUnformattedText().equalsIgnoreCase("\u043f\u0457\u0405f[\u043f\u0457\u0405eY\u043f\u0457\u0405f]\u043f\u0457\u0405e" + entityIn.getName()) ? ColorHelper.getColor(new Color(255, 255, 60)) : (entityIn.getDisplayName().getUnformattedText().equalsIgnoreCase("\u043f\u0457\u0405f[\u043f\u0457\u0405aG\u043f\u0457\u0405f]\u043f\u0457\u0405a" + entityIn.getName()) ? ColorHelper.getColor(new Color(60, 255, 60)) : ColorHelper.getColor(new Color(255, 255, 255)))));
        return i;
    }
    ...
    public static int astolfoColors1(float yDist, float yTotal) {
        ...
        return Color.HSBtoRGB(hue += 0.5f, 0.4f, 1.0f);
    }
    ...
    public static int astolfoColors2(float yDist, float yTotal) {
        ...
        return Color.HSBtoRGB(hue += 0.5f, 0.5f, 0.75f);
    }
    ...
    public static int astolfoColors3(float yDist, float yTotal) {
        ...
        return Color.HSBtoRGB(hue += 0.5f, 0.2f, 1.0f);
    }
    ...
    public static class Colors {
        public static final int WHITE = ColorHelper.toRGBA(255, 255, 255, 255);
        public static final int BLACK = ColorHelper.toRGBA(0, 0, 0, 255);
        public static final int RED = ColorHelper.toRGBA(255, 0, 0, 255);
        public static final int GREEN = ColorHelper.toRGBA(0, 255, 0, 255);
        public static final int BLUE = ColorHelper.toRGBA(0, 0, 255, 255);
        public static final int ORANGE = ColorHelper.toRGBA(255, 128, 0, 255);
        public static final int PURPLE = ColorHelper.toRGBA(163, 73, 163, 255);
        public static final int GRAY = ColorHelper.toRGBA(127, 127, 127, 255);
        public static final int DARK_RED = ColorHelper.toRGBA(64, 0, 0, 255);
        public static final int YELLOW = ColorHelper.toRGBA(255, 255, 0, 255);
